...
/*   Updated: 2023/01/30 20:39:16 by sriyani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
RobotomyRequestForm::RobotomyRequestForm():_sign(false),_robosign(72),_roboexec(45)
{
	std::cout <<"RobotomyRequestForm default constuctor"<<std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(std::string target):_name(target),_sign(false),_robosign(72),_roboexec(45)
{
