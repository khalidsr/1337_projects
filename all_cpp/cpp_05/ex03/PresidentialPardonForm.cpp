...
/*   Updated: 2023/01/30 20:29:09 by sriyani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "PresidentialPardonForm.hpp"

PresidentialPardonForm::PresidentialPardonForm():_presidentsign(25),_presidentexec(5)
{
	std::cout <<"PresidentialPardonForm default constuctor"<<std::endl;
}
PresidentialPardonForm::PresidentialPardonForm(std::string target):_name(target),_presidentsign(25), _presidentexec(5)
{
